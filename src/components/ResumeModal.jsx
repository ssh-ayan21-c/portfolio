    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-6xl h-full max-h-[90vh] bg-[var(--theme-primary)] rounded-3xl shadow-2xl overflow-y-auto overflow-x-hidden flex flex-col md:flex-row custom-scrollbar"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close Button */}
          <button 
            onClick={onClose}
            className="absolute top-6 right-6 w-10 h-10 rounded-full bg-black/10 dark:bg-white/10 flex items-center justify-center text-content hover:bg-black/20 dark:hover:bg-white/20 transition-colors z-50 pointer-events-auto cursor-pointer"
          >
          ...
          <div className="w-full md:w-7/12 p-8 md:p-12 border-b md:border-b-0 md:border-r border-content/10">
            <div className="mb-12">
              <h1 className="text-4xl md:text-5xl font-black text-content mb-2 tracking-tight">Ayan Mekrani</h1>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 bg-content text-[var(--theme-primary)] px-6 py-3 rounded-full font-bold shadow-lg hover:scale-105 transition-transform pointer-events-auto cursor-pointer"
              >
                Download PDF
            ...
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-content border-b border-content/10 pb-2 mb-6">Experience</h2>
            ...
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-content border-b border-content/10 pb-2 mb-6">Projects</h2>
          ...
          <div className="w-full md:w-5/12 p-8 md:p-12 bg-black/5 dark:bg-white/5">
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-content border-b border-content/10 pb-2 mb-6">Skills</h2>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {['C', 'C++', 'Python', 'JavaScript', 'SQL', 'HTML', 'CSS'].map(skill => (
                    <span key={skill} className="px-3 py-1 bg-content/10 rounded-full text-sm font-medium text-content">{skill}</span>
                  ))}
                </div>
              </div>
            ...
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-content border-b border-content/10 pb-2 mb-6">Education</h2>
              <div>
            ...
            <div className="mb-10">
              <h2 className="text-2xl font-bold text-content border-b border-content/10 pb-2 mb-6">Leadership & Achievements</h2>
              <div className="mb-4">
